...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="overflow-y-clip min-h-screen md:min-h-[200vh] flex flex-col items-center py-0 md:py-40 justify-start flex-shrink-0 [perspective:800px] transform scale-[0.45] sm:scale-[0.99]"
    >
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 font-bold mb-20 text-center w-full"
      >
        {title || ( 
          <div>
            <div className="text-4xl xl:text-6xl mx-auto text-neutral-600 dark:text-neutral-400">
            <span className="bg-gradient-to-r from-purple-400 to-pink-500 text-transparent bg-clip-text animate-text">Santhosh Toorpu</span> is A <br /><FlipWords words={words} />
          </div>
          <div className="pt-10 flex justify-center gap-8 lg:gap-12">
        <Link href={"https://github.com/SanthoshToorpu"}>
                <Button
                borderRadius="1.5rem"
                className="bg-white dark:bg-slate-900 text-black dark:text-white border-neutral-200 dark:border-slate-800 "
            >
                GitHub <FaGithub className="ml-3 h-8 w-8" />
            </Button>
        </Link>
        <Link href={"https://www.linkedin.com/in/santhoshtoorpu/"}>
        <Button
        borderRadius="1.5rem"
        className="bg-white dark:bg-slate-900 text-black dark:text-white border-neutral-200 dark:border-slate-800 "
      >
        LinkedIn <FaLinkedin className="ml-3 h-8 w-8"/>
      </Button>
        </Link>
          </div>
          </div>
